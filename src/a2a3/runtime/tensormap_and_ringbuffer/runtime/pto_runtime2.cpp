...
static void submit_task_impl(PTO2Runtime* rt, int32_t kernel_id, CoreType core_type,
                             const PTOParam& params) {
    pto2_submit_task(&rt->orchestrators[pto2_current_orch_idx], kernel_id, core_type,
                     params);
}
